# PlantCV Region of Interest Tutorial

The region of interest (ROI) tutorial shows examples of methods used to create
ROIs to focus analyses on specific areas of an image.

[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/danforthcenter/plantcv-binder/HEAD?filepath=notebooks/roi_tutorial/roi_package.ipynb)
